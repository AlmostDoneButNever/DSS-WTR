...
class Food(object):
    ...
    def decomposeId(self, wasteID):
        ...
        self.CHNType=self.id[2]
        self.CRatio=self.id[3:5]
        self.HRatio=self.id[5:7]
        self.NRatio=self.id[7:9]
        self.proteinType=self.id[9]
        self.proteinRatio=self.id[10:12]
        self.cellulosic=self.id[12]
        self.shellAndBones=self.id[13:15]
        self.moistureType=self.id[15]
        self.moistureContent=self.id[16:18]
        self.saltType=self.id[18]
        self.saltContent=self.id[19:21]
        self.pHType=self.id[21]
        self.phValue=self.id[22:24]
        self.particleSize=self.id[24]
        return self
